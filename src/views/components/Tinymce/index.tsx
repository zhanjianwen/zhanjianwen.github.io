...
public state={
  ...
  initTinymce() {
    // const { tinymceId, menubar, height, toolbar, content} = this.props
    // const _this = this
  ...
  render() {
    ...
    // );
    return (
      <div className='tinymce-components'>
        {/* <Page header={header} loading={!!loading}> */}
          <div className={fullscreen ? "tinymce-container mce-fullscreen" : "tinymce-container"}>
